  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Gratis offertes aanvragen — Onafhankelijke Offerte" },
      {
        ...
        content:
          "In 3 stappen tot 3 offertes van gecontroleerde installateurs. Gratis en vrijblijvend.",
      },
      ...
      <div className="mx-auto max-w-3xl px-5 pb-20">
            ...
            {step === 2 && (
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <p className="text-xs text-moss/60 sm:col-span-2">
                  Door te verzenden mogen maximaal 3 gecontroleerde installateurs contact met je
                  opnemen over deze aanvraag. Bedragen zijn indicatief en geen aanbod.
                </p>
              </div>
            )}
        ...
        {verify && (
          ...
          >
            ...
            <p className="mt-1.5 text-sm text-moss/75">
              We hebben een code van 6 cijfers gestuurd naar {verify.phoneMasked}. Je aanvraag gaat
              pas naar installateurs nadat je het nummer bevestigt.
            </p>
        ...
        <p className="mt-6 text-center text-sm text-moss/70">
          Installateur?{" "}
          <Link to="/auth" className="font-semibold text-leaf hover:underline">
            Log in op het partnerdashboard
          </Link>
        </p>
      </div>
    </main>
